...
def table_analysis():
    results = pd.read_sql("select monthly_price, review_scores_rating, availability_365, number_of_reviews,reviews_per_month, maximum_nights, minimum_nights from listings", con=db.engine)
